        ...
        <div class="panel panel-bd">
            <div id="printableArea">
                    ...
                    <div class="invoice-wrap"
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="text-align: left;"><?php echo display('cr_no');?></th>
                                    <th style="text-align: right;"><?php echo $contact; ?></th>
                                </tr>
                                <tr>
                ...
                foreach($invoice_all_data as $invoice_data){?>
                                ...
                                <?php 
                                $total_discount += $invoice_data['discount'];
                                ...
                                <?php $sl++; } ?>
                                <tr>
                                    <th colspan='3' style="border: 1px solid #000;"><?php echo display('total'); ?></th>
                                    <th style="border: 1px solid #000;"><?= number_format($itemrow, 2, '.', ','); ?></th>
                                </tr>
                                <tr>
                                    <th colspan='3' style="border: 1px solid #000;"><?php echo display('discount'); ?></th>
                                    <th style="border: 1px solid #000;"><?= number_format($total_discount, 2, '.', ','); ?></th>
                                </tr>
                                <tr>
                                    <th colspan='3' style="border: 1px solid #000;"><?php echo display('net'); ?></th>
                                    <th style="border: 1px solid #000;"><?= number_format($total_price_with_dis, 2, '.', ','); ?></th>
                                </tr>
                            </tbody>
                        </table>

                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            style="color: #000;font-size: 11px;margin-bottom: 20px;display:none;">
                            <tbody>
                                <tr>
