            ...
            <div class="row" id="">
               <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" name="dtpToDate" value="<?php echo (!empty($dtpToDate)?$dtpToDate:'')?>"
                           placeholder="<?php echo display('date') ?>" class="datepicker form-control">
                     </div>
                  </div>
         ...
         <div class="panel-heading">
            <div id="printableArea">
               <div class="panel-body print-font-size">
                  <tr align="center">
                     <td id="ReportName"><b><?php echo display('cash_balance_voucher')?></b></td>
                  </tr>
                  <div>

                     <div class="table-responsive">
                        <table width="100%" class="datatable table table-stripped table-hover print-font-size"
                           cellpadding="6" cellspacing="1">
                           <thead class="table-bordered">
                              <tr>
                                 <td height="25" width="5%"><strong><?php echo display('sl');?>dsdsds</strong></td>
                           ...
                           <tbody class="table-bordered">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php if($data->Vtype=='DV') {echo 'Debit';} else if($data->Vtype=='CV') { echo 'Credit';} else if ($data->Vtype=='JV') { echo 'Journal';} else { echo 'Contra';} ?>
                                 </td>
                           ...
                           <caption class="text-center" style="border-bottom: 1px #c9c9c9 solid;">
                              <strong> <?php echo display('cash_balance_report')?>
