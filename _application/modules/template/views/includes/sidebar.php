    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php
                    if ($this->uri->segment('2') == ("voucher_report") || $this->uri->segment('1') == ("expenditure_statement") ||  $this->uri->segment('1') == ("expenditure_statement_report") || $this->uri->segment('1') == ("bank_reconciliation_report") || $this->uri->segment('1') == ("receipt_payment") || $this->uri->segment('1') == ("receipt_payment_report") || $this->uri->segment('1') == ("income_statement_form") ||  $this->uri->segment('1') == ("income_statement") || $this->uri->segment('1') == ("fixedasset_schedule") ||  $this->uri->segment('1') == ("fixed_assets_report") || $this->uri->segment('1') == ("cash_book") || $this->uri->segment('1') == ("cash_book_report") || $this->uri->segment('1') == ("cash_balance") || $this->uri->segment('1') == ("cash_balance_report") || $this->uri->segment('1') == ("bank_book") || $this->uri->segment('1') == ("bank_book_report") || $this->uri->segment('1') == ("day_book") || $this->uri->segment('1') == ("day_book_report") || $this->uri->segment('1') == ("general_ledger")  || $this->uri->segment('1') == ("sub_ledger") || $this->uri->segment('1') == ("sub_ledger_report") || $this->uri->segment('1') == ("accounts_report_search") || $this->uri->segment('1') == ("trial_balance") || $this->uri->segment('1') == ("trial_balance_report") || $this->uri->segment('1') == ("profit_loss_form") || $this->uri->segment('1') == ("profit_loss_report_search") || $this->uri->segment('1') == ("profit_loss_report") || $this->uri->segment('1') == ("cash_flow")|| $this->uri->segment('1') == ("inventory_ledger")|| $this->uri->segment('1') == ("coa_print") || $this->uri->segment('1') == ("cashflow_form") || $this->uri->segment('1') == ("balance_sheet")) {
                        echo "active";
                    } else {
                        echo " ";
                    }
                    ...
                    <?php if($this->permission1->method('cash_book','read')->access()){ ?>
                        ...
                        <?php }?>
							...
							<?php if($this->permission1->method('cash_balance','read')->access()){ ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("cash_balance")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('cash_balance') ?>"><?php echo display('cash_balance'); ?></a></li>
                        <?php }?>
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("product_wise_sales_report")){
                        ...
                        href="<?php echo base_url('customer_history') ?>">Customer History</a>
                </li>
                <?php } ?>
                <?php if($this->permission1->method('sales_report_category_wise','read')->access()){ ?>
                <li class="treeview <?php if ($this->uri->segment('1') == ("customer_history")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a
        ...
        <li class="treeview <?php
            ...
            ?>">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("autoupdate")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('autoupdate/Autoupdate')?>"><i class="fa fa-cloud-download"
                            aria-hidden="true"></i> <span><?php echo display('update_now'); ?></span></a></li>
                <?php }?>
            </ul>
        </li>
        <?php }?>
