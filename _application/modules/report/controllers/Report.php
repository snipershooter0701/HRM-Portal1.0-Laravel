...
class Report extends MX_Controller {
 ...
 /*product stock part*/
    ...
    //    ============ its for todays_customer_receipt =============
     ...
     public function bdtask_customer_history(){
        $from_date      =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date        = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
        $customer_id     = (!empty($this->input->get('customer_id'))?$this->input->get('customer_id'):'');
        $product_report = $this->report_model->retrieve_product_sales_report($from_date,$to_date,$customer_id);
        ...
        if ($customer_id) $type = 'customer_search';
        else $type = null;
        $data = array(
