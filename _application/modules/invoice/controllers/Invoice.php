...
class Invoice extends MX_Controller {
 ...
 public function bdtask_customer_autocomplete(){
        ...
        $customers  = $this->invoice_model->customer_search($customer_id);
        $customer_info = $customers['data'];
        $type = $customers['type'];
        $list[''] = '';
        foreach ($customer_info as $value) {
            if ($type == 'name')
                ...
                $json_customer[] = array('label'=>$value['phone'],'value'=>$value['customer_id']);
            else if ($type == 'contact')
                $json_customer[] = array('label'=>$value['contact'],'value'=>$value['customer_id']);
